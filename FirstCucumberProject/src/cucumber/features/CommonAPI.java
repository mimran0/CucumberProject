...
public class CommonAPI {
	...
	// Input: this function/method takes string URL of the page as input argument
		...
		public String OpenChromeBrowser(String url){
			String result=null;
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\imran\\workspace7\\FirstCucumberProject\\driver\\chromedriver.exe");
		...
		public WebDriver getDriver(String BrowserName,String url) {
		    ...
		    case "CHROME":
		    	...
		    	break;
		    case "FIREFOX":	    	
		    	System.setProperty("webdriver.gecko.driver", "C:\\Users\\imran\\workspace7\\FirstCucumberProject\\driver\\geckodriver.exe");
				driver=new FirefoxDriver();			
		    	break;	
		    case "MICROSOFE EDGE":	    	
		    	System.setProperty("webdriver.edge.driver", "C:\\Users\\imran\\workspace7\\FirstCucumberProject\\driver\\MicrosoftWebDriver.exe");
		    	driver = new EdgeDriver();			
		    	break;
		    case "IE":	    	
		    	System.setProperty("webdriver.ie.driver", "C:\\Users\\imran\\workspace7\\FirstCucumberProject\\driver\\IEDriverServer.exe");
